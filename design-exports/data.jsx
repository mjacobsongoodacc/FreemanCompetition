...
// Draws from source/lib/mock-data.ts — kept minimal, what the marketing
// page actually surfaces pre-auth.
...
window.SHEPHERD = {
  ...
  // Narrative lines used across variants — not padding, these are product voice
  manifesto: {
    tagline: "When the plan breaks, Shepherd walks with you.",
    pitch: "A personal disaster companion for the moments your plan doesn't survive contact with the storm.",
    paragraphs: [
